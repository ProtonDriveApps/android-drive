...
class AddToAlbumInfo @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        addToAlbumInfo(null, photoListings)
    }
    ...
    suspend operator fun invoke(
        ...
        addToAlbumInfo(albumId, photoListings)
    }

    private suspend fun addToAlbumInfo(albumId: AlbumId?, photoListings: Set<PhotoListing>) =
        repository.addPhotoListings(
            albumId = albumId,

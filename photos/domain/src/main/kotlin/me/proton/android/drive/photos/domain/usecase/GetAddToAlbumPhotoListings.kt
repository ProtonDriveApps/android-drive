...
class GetAddToAlbumPhotoListings @Inject constructor(
    private val repository: AlbumInfoRepository,
) {

    suspend operator fun invoke(userId: UserId, albumId: AlbumId?) = coRunCatching {
        repository.getPhotoListings(userId, albumId)
    }
}

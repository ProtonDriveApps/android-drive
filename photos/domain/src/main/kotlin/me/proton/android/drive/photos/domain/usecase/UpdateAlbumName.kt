...
class UpdateAlbumName @Inject constructor(
    private val repository: AlbumInfoRepository,
) {
    suspend operator fun invoke(userId: UserId, albumName: String) = coRunCatching {
        repository.updateName(userId, albumName)
    }
}

...
class TransferDataNotificationBuilder @Inject constructor(
    @ApplicationContext private val appContext: Context,
    private val commonBuilder: CommonNotificationBuilder,
    private val contentIntent: CreateContentPendingIntent,
) {
    operator fun invoke(notificationId: NotificationId.User, event: Event.TransferData) =
        commonBuilder(notificationId, event)
            .setContentTitle(appContext.getString(R.string.notification_content_title_transferring))

...
data class SummerSalePromoViewState(
    @param:DrawableRes val titleImageResId: Int,
    @param:DrawableRes val subtitleImageResId: Int,
    ...
    val paymentButtonViewState: ProtonPaymentButtonViewState? = null,
) {
    data class Item(
        @param:DrawableRes val imageResId: Int,
        @param:DrawableRes val imageLandResId: Int,
        val title: String
    )
}

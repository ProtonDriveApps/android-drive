...
class ConfirmStopLinkSharingDialogViewModel @Inject constructor(
    ...
    val shareId = ShareId(
        userId,
        savedStateHandle.require(Screen.Files.Dialogs.ConfirmStopLinkSharing.SHARE_ID)
    )
    val linkId: LinkId = FileId(
        shareId,
        savedStateHandle.require(Screen.Files.Dialogs.ConfirmStopLinkSharing.LINK_ID)
    )

...
class PhotosConnectedDefaultConfigurationProvider @Inject constructor(
) : PhotosDefaultConfigurationProvider {
    override fun get(folderId: FolderId) = super.get(folderId).copy(
        networkType = BackupNetworkType.CONNECTED,
    )
}

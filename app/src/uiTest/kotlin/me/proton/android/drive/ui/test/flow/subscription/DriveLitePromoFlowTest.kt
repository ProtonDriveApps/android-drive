...
@HiltAndroidTest
class DriveLitePromoFlowTest : BaseTest() {

    override val shouldShowDriveLitePromoAfterLogin = true
    ...
    @FeatureFlag(DRIVE_ONE_DOLLAR_PLAN_UPSELL, ENABLED)
    @Ignore("Not in production yet")
    fun driveLitePromoIsShownForFreeUsers() = runTest {

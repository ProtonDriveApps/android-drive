...
import me.proton.android.drive.usecase.TestIsNotificationsPermissionShowRationale
import me.proton.core.notification.dagger.CoreNotificationModule
...
@TestInstallIn(
    ...
    replaces = [CoreNotificationModule::class]
)
public interface TestNotificationModule {
    @Binds
    ...
    public fun bindIsNotificationsPermissionShowRationale(
        impl: TestIsNotificationsPermissionShowRationale

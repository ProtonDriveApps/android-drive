...
suspend fun ShareContext.invitation(shareInvitationEntity: ShareInvitationEntity) {
    db.shareInvitationDao.insertOrIgnore(shareInvitationEntity)
}

@Suppress("FunctionName")
fun ShareContext.NullableShareInvitationEntity(
    email: String,

...
class SetOrIgnoreInitialBackup @Inject constructor(
    private val repository: BackupStatsRepository,
) {
    suspend operator fun invoke(folderId: FolderId) = coRunCatching {
        repository.insertOrIgnoreInitialBackup(folderId, TimestampS())
    }
}

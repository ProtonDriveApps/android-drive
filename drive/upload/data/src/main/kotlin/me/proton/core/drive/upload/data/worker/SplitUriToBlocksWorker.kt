...
class SplitUriToBlocksWorker @AssistedInject constructor(
    ...
    override suspend fun doLimitedRetryUploadWork(uploadFileLink: UploadFileLink): Result {
        uploadFileLink.logWorkState("split (size = ${uploadFileLink.size}) uri to blocks")
        return splitUriToBlocks(
    ...
    companion object {
        fun getWorkRequest(
            ...
            OneTimeWorkRequest.Builder(SplitUriToBlocksWorker::class.java)
                .setInputData(
                    Data.Builder()

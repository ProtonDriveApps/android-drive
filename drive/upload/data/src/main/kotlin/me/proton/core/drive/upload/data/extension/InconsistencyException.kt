...
fun InconsistencyException.getDefaultMessage(context: Context): String =
    context.getString(R.string.common_error_internal)

fun InconsistencyException.log(tag: String, message: String = this.message.orEmpty()): InconsistencyException = also {

...
@Entity(
    foreignKeys = [
        ...
        ForeignKey(
            ...
            childColumns = [USER_ID, VOLUME_ID, SHARE_ID, TAG, LINK_ID],
            onDelete = ForeignKey.CASCADE
        ),
    ],
    indices = [
        Index(value = [KEY]),
        Index(value = [KEY, USER_ID, VOLUME_ID, SHARE_ID, TAG, LINK_ID], unique = true),
    ],
)
data class TaggedPhotoListingRemoteKeyEntity(

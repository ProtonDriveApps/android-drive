...
class PhotoListingRemoteMediator @Inject constructor(
    ...
    private val remoteKeyDao = database.photoListingRemoteKeyDao
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val nextPageKey = if (endOfPaginationReached) {
                ...
                photoListings.minByOrNull { it.captureTime }?.linkId?.id
            }

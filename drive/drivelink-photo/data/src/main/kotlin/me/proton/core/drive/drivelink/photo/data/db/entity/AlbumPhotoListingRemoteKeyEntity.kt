...
@Entity(
    foreignKeys = [
        ...
        ForeignKey(
            ...
            childColumns = [USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID, LINK_ID],
            onDelete = ForeignKey.CASCADE
        ),
    ],
    indices = [
        Index(value = [ID]),
        Index(value = [KEY]),
        Index(value = [KEY, USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID, LINK_ID], unique = true)
    ],
)
data class AlbumPhotoListingRemoteKeyEntity(

...
class GetFeatureFlagFlowTest {

    @get:Rule
    var driveRule = DriveRule(this)

    @Inject
    lateinit var getFeatureFlagFlow: GetFeatureFlagFlow
    ...
    fun enabled() = runTest {
        ...
        val featureFlag = getFeatureFlagFlow(featureId).take(2).last()
    ...
    fun not_found() = runTest {
        ...
        val featureFlag = getFeatureFlagFlow(featureId).take(1).last()

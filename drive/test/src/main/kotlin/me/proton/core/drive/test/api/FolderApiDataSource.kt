...
fun MockWebServer.foldersDeleteMultiple(responses: List<LinkResponse> = emptyList()) {
    foldersDeleteMultiple {
        jsonResponse { LinkResponses(ProtonApiCode.SUCCESS, responses) }
    }
}

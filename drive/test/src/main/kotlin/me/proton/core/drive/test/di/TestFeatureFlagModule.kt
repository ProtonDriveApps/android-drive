...
import me.proton.core.drive.test.manager.TestFeatureFlagWorkerManager
import me.proton.core.featureflag.dagger.CoreFeatureFlagModule
...
@TestInstallIn(
    ...
    replaces = [CoreFeatureFlagModule::class]
)
interface TestFeatureFlagModule {
    ...
    @Binds
    @Singleton
    abstract fun bindRepository(impl: FeatureFlagRepositoryImpl): FeatureFlagRepository

    @Binds
    @Singleton
    abstract fun bindManager(impl: FeatureFlagManagerImpl): FeatureFlagManager

    @Binds
    @Singleton
    public fun bindWorkerManager(impl: TestFeatureFlagWorkerManager): FeatureFlagWorkerManager

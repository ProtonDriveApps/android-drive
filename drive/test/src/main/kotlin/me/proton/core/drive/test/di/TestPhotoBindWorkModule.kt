...
import me.proton.core.drive.photo.data.di.PhotoBindWorkModule
...
@TestInstallIn(
    ...
    replaces = [PhotoBindWorkModule::class],
)
interface TestPhotoBindWorkModule {

    @Binds
    @Singleton
    fun bindsPhotoTagWorkManagerImpl(
        impl: TestPhotoTagWorkManager,
    ): PhotoTagWorkManager
}

...
@HiltWorker
class TagsMigrationUpdateStatusWorker @AssistedInject constructor(
    @Assisted appContext: Context,
    @Assisted workerParams: WorkerParameters,
    private val tagsMigrationUpdateStatus: TagsMigrationUpdateStatus,
) : CoroutineWorker(
    ...
    override suspend fun doWork(): Result = tagsMigrationUpdateStatus(
        volumeId = volumeId,
        fileId = fileId,
    ).fold(
        onSuccess = {
    ...
    companion object {
        fun getWorkRequest(
            ...
            OneTimeWorkRequest.Builder(TagsMigrationUpdateStatusWorker::class.java)
                .setConstraints(
                    Constraints.Builder()

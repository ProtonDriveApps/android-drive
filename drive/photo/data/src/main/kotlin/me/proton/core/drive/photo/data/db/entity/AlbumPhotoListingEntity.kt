...
import me.proton.core.drive.base.data.db.Column.ADDED_TIME
...
import me.proton.core.drive.base.data.db.Column.IS_CHILD_OF_ALBUM
...
@Entity(
    ...
    indices = [
        ...
        Index(value = [USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID]),
    ],
)
data class AlbumPhotoListingEntity(
    ...
    val addedTime: Long,
    @ColumnInfo(name = IS_CHILD_OF_ALBUM)

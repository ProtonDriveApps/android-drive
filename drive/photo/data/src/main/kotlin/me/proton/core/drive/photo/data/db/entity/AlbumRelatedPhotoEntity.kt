...
@Entity(
    primaryKeys = [USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID, ID],
    foreignKeys = [
        ForeignKey(
        ...
        ForeignKey(
            entity = AlbumPhotoListingEntity::class,
            parentColumns = [USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID, ID],
            childColumns = [USER_ID, VOLUME_ID, SHARE_ID, ALBUM_ID, MAIN_PHOTO_LINK_ID],
            onDelete = ForeignKey.CASCADE
        ),
    ],
    indices = [
        ...
        Index(value = [USER_ID, VOLUME_ID, ALBUM_ID, MAIN_PHOTO_LINK_ID]),
    ],
)
data class AlbumRelatedPhotoEntity(

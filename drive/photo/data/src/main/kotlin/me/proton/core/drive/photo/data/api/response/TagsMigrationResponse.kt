...
import me.proton.core.drive.base.data.api.Dto.LAST_CLIENT_UID
import me.proton.core.drive.base.data.api.Dto.LAST_MIGRATION_TIMESTAMP
...
@Serializable
data class TagsMigrationResponse(
    @SerialName(CODE)
    val code: Long,
    @SerialName(FINISHED)
    ...
    data class Anchor(
        ...
        @SerialName(LAST_MIGRATION_TIMESTAMP)
        val lastMigrationTimestamp: Long,
        @SerialName(LAST_CLIENT_UID)
        val lastClientUid: String? = null,
    )
}

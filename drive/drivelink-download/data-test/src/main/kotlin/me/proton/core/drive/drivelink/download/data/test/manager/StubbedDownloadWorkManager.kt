...
package me.proton.core.drive.drivelink.download.data.test.manager
...
class StubbedDownloadWorkManager @Inject constructor(): DownloadWorkManager {
    override suspend fun download(driveLink: DriveLink, retryable: Boolean) {
        // do nothing
    }

    override fun cancel(driveLink: DriveLink) {
        // do nothing
    }

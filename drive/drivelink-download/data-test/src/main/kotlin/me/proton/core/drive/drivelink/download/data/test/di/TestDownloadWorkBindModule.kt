 ...
 */
package me.proton.core.drive.drivelink.download.data.test.di
...
import me.proton.core.drive.drivelink.download.data.test.manager.StubbedDownloadWorkManager
...
interface TestDownloadWorkBindModule {
    ...
    @Binds
    @Singleton
    fun bindsDownloadWorkManager(impl: StubbedDownloadWorkManager): DownloadWorkManager
}

...
class UpdateUriString @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        linkUploadRepository.updateUploadFileLinkUri(uploadFileLinkId, uriString)
    }
    ...
    suspend operator fun invoke(
        ...
        linkUploadRepository.updateUploadFileLinkUri(uploadFileLinkId, uriString, shouldDeleteSourceUri)
    }
}

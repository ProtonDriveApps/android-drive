...
fun Link.File.toDriveLink(
    ...
    isMarkedAsOffline: Boolean = false,
    isAnyAncestorMarkedAsOffline: Boolean = false,
): DriveLink.File =
    DriveLink.File(
        link = this,
        ...
        trashState = if (trashedTime != null) TrashState.TRASHED else null,
...
fun Link.toDriveLink(
    downloadState: DownloadState? = null,
    isMarkedAsOffline: Boolean = false,
    isAnyAncestorMarkedAsOffline: Boolean = false,
) = when (this) {
    is Link.File -> toDriveLink(
        downloadState = downloadState,
        isMarkedAsOffline = isMarkedAsOffline,
        isAnyAncestorMarkedAsOffline = isAnyAncestorMarkedAsOffline,
    )

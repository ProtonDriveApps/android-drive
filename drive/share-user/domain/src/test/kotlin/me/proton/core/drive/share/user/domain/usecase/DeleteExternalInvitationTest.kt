...
class DeleteExternalInvitationTest {

    @get:Rule
    val driveRule = DriveRule(this)

    @Inject
    lateinit var deleteExternalInvitation: DeleteExternalInvitation
    ...
    fun `happy path`() = runTest {
        ...
        val result = deleteExternalInvitation(
    ...
    fun fails() = runTest {
        driveRule.server.run {
            deleteExternalInvitation { errorResponse() }
        }

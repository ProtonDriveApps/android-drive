...
import me.proton.core.drive.share.domain.usecase.GetOldestUnlockedShare
import me.proton.core.drive.volume.domain.entity.VolumeId
import javax.inject.Inject

class GetPhotoShare @Inject constructor(
    ...
    operator fun invoke(userId: UserId, volumeId: VolumeId): Flow<DataResult<Share>> =
        getOldestUnlockedShare(userId, volumeId, Share.Type.PHOTO)

    operator fun invoke(userId: UserId): Flow<DataResult<Share>> =
        getOldestUnlockedShare(userId, Share.Type.PHOTO)
}

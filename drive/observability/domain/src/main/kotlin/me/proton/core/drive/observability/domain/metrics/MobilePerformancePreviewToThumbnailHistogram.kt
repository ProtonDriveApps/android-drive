...
@Serializable
@Schema(description = "Tracks the time to load intermediate thumbnail in preview.")
@SchemaId("https://proton.me/drive_mobile_performance_previewToThumbnail_histogram_v1.schema.json")
data class MobilePerformancePreviewToThumbnailHistogram(

...
@Serializable
@Schema(description = "Tracks the time to load full content preview.")
@SchemaId("https://proton.me/drive_mobile_performance_previewToFullContent_histogram_v1.schema.json")
data class MobilePerformancePreviewToFullContentHistogram(

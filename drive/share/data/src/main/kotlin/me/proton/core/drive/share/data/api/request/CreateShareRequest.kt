...
import me.proton.core.drive.base.data.api.Dto.NAME_KEY_PACKET
import me.proton.core.drive.base.data.api.Dto.PASSPHRASE_KEY_PACKET
import me.proton.core.drive.base.data.api.Dto.ROOT_LINK_ID
...
data class CreateShareRequest(
    ...
    @SerialName(PASSPHRASE_KEY_PACKET)
    val passphraseKeyPacket: String,
    @SerialName(NAME_KEY_PACKET)

...
object Dto {
    ...
    const val ALBUM_DATA = "AlbumData"
    const val ALBUM_LINK_ID = "AlbumLinkID"
    ...
    const val DRIVE_SHARE_REFRESH = "DriveShareRefresh"
    const val DUPLICATE_HASHES = "DuplicateHashes"
    const val EDITORS_CAN_SHARE = "EditorsCanShare"
    ...
    const val LAST_CLIENT_UID = "LastClientUID"
    const val LAST_MIGRATION_TIMESTAMP = "LastMigrationTimestamp"
    const val LAST_PROCESSED_LINK_ID = "LastProcessedLinkID"
    const val LAST_PROCESSED_CAPTURE_TIME = "LastProcessedCaptureTime"
    ...
    const val NEW_LINK_ID = "NewLinkID"
    const val NEW_VOLUME_ID = "NewVolumeID"
    ...
    const val OLD_VOLUME_ID = "OldVolumeID"
    const val ORIGINAL_HASH = "OriginalHash"
    const val ORGANIZATION = "Organization"
    const val OWNED_BY = "OwnedBy"
    ...
    const val RELATED_PHOTOS = "RelatedPhotos"
    const val RELATED_PHOTOS_LINK_IDS = "RelatedPhotosLinkIDs"
    ...
    const val SHARE_TARGET_TYPE = "ShareTargetType"
    ...
    const val TAGS = "Tags"
    const val TARGET_PARENT_LINK_ID = "TargetParentLinkID"
    const val TARGET_VOLUME_ID = "TargetVolumeID"

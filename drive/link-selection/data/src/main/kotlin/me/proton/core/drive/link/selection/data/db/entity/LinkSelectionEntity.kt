 ...
 */
package me.proton.core.drive.link.selection.data.db.entity
...
@Entity(
    primaryKeys = [USER_ID, SHARE_ID, LINK_ID, SELECTION_ID],
    foreignKeys = [
        ForeignKey(
    ...
    indices = [
        ...
        Index(value = [LINK_ID]),
        Index(value = [SELECTION_ID]),
    ],
)
data class LinkSelectionEntity(

...
import me.proton.core.key.domain.encryptAndSignTextWithCompression
...
class EncryptAndSignTextWithCompression @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        signKey.useKeysAs(cryptoContext) { key ->
            key.encryptAndSignTextWithCompression(text, encryptKey.publicKeyRing(cryptoContext))
        }
    }
}

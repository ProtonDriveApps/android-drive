...
import me.proton.core.drive.file.base.data.api.entity.ThumbnailDto
import me.proton.core.drive.file.base.data.api.entity.ThumbnailErrorDto

@Serializable
data class GetThumbnailsUrlsResponse(
    @SerialName(CODE)
    val code: Long,
    @SerialName(THUMBNAILS)
    val thumbnails: List<ThumbnailDto>,
    @SerialName(ERRORS)
    val errors: List<ThumbnailErrorDto>,
)

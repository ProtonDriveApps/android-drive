...
import me.proton.core.drive.base.data.api.Dto.LINK_IDS
import me.proton.core.drive.base.data.api.Dto.SHARE_URLS

@Serializable
data class ShareUrlContext(
    @SerialName(CONTEXT_SHARE_ID)
    val contextShareId: String,
    @SerialName(SHARE_URLS)
    val shareUrls: List<ShareUrlDto>,
    @SerialName(LINK_IDS)

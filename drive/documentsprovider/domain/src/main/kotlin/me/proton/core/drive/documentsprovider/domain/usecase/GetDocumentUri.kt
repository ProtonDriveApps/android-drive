...
class GetDocumentUri @Inject constructor(
    ...
    operator fun invoke(userId: UserId, linkId: LinkId) = invoke(DocumentId(userId, linkId))

    operator fun invoke(documentId: DocumentId) = repository.getDocumentsUri(documentId)
